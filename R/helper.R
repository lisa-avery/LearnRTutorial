# NOTE: These functions will be accessed by the tutorials when they are tested
# by knitting.
# However, to run the tutorials from within the package this code must be
# sourced by the tutorial the copy.R script can be used to copy the final set of
# functions to each tutorial prior to distribution.
# ******************************************************************************
...
# Also: Both this file, and style.css are replicated in the css folder where the
# learnR files are kept
# ******************************************************************************
...
# At the moment, only the first two are used,
# but it's probably a good idea to have a few
